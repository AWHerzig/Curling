...
class League:
    def __init__(self):
        self.NA = pd.DataFrame({
            ...
            'Skills ': [NAteams[0].sStr, NAteams[1].sStr, NAteams[2].sStr, NAteams[3].sStr, NAteams[4].sStr],
            'Played': [NAteams[0].played, NAteams[1].played, NAteams[2].played, NAteams[3].played, NAteams[4].played],
            'S Wins': [NAteams[0].wins, NAteams[1].wins, NAteams[2].wins, NAteams[3].wins, NAteams[4].wins],
            'S PD': [NAteams[0].pD, NAteams[1].pD, NAteams[2].pD, NAteams[3].pD, NAteams[4].pD],
            'T Wins': [NAteams[0].tWins, NAteams[1].tWins, NAteams[2].tWins, NAteams[3].tWins, NAteams[4].tWins],
            'T PD': [NAteams[0].tPD, NAteams[1].tPD, NAteams[2].tPD, NAteams[3].tPD, NAteams[4].tPD]
        })
        self.SA = pd.DataFrame({
            ...
            'Skills ': [SAteams[0].sStr, SAteams[1].sStr, SAteams[2].sStr, SAteams[3].sStr, SAteams[4].sStr],
            'Played': [SAteams[0].played, SAteams[1].played, SAteams[2].played, SAteams[3].played, SAteams[4].played],
            'S Wins': [SAteams[0].wins, SAteams[1].wins, SAteams[2].wins, SAteams[3].wins, SAteams[4].wins],
            'S PD': [SAteams[0].pD, SAteams[1].pD, SAteams[2].pD, SAteams[3].pD, SAteams[4].pD],
            'T Wins': [SAteams[0].tWins, SAteams[1].tWins, SAteams[2].tWins, SAteams[3].tWins, SAteams[4].tWins],
            'T PD': [SAteams[0].tPD, SAteams[1].tPD, SAteams[2].tPD, SAteams[3].tPD, SAteams[4].tPD]
        ...
        self.WE = pd.DataFrame({
            ...
            'Skills ': [WEteams[0].sStr, WEteams[1].sStr, WEteams[2].sStr, WEteams[3].sStr, WEteams[4].sStr],
            'Played': [WEteams[0].played, WEteams[1].played, WEteams[2].played, WEteams[3].played, WEteams[4].played],
            'S Wins': [WEteams[0].wins, WEteams[1].wins, WEteams[2].wins, WEteams[3].wins, WEteams[4].wins],
            'S PD': [WEteams[0].pD, WEteams[1].pD, WEteams[2].pD, WEteams[3].pD, WEteams[4].pD],
            'T Wins': [WEteams[0].tWins, WEteams[1].tWins, WEteams[2].tWins, WEteams[3].tWins, WEteams[4].tWins],
            'T PD': [WEteams[0].tPD, WEteams[1].tPD, WEteams[2].tPD, WEteams[3].tPD, WEteams[4].tPD]
        })
        self.EE = pd.DataFrame({
            ...
            'Skills ': [EEteams[0].sStr, EEteams[1].sStr, EEteams[2].sStr, EEteams[3].sStr, EEteams[4].sStr],
            'Played': [EEteams[0].played, EEteams[1].played, EEteams[2].played, EEteams[3].played, EEteams[4].played],
            'S Wins': [EEteams[0].wins, EEteams[1].wins, EEteams[2].wins, EEteams[3].wins, EEteams[4].wins],
            'S PD': [EEteams[0].pD, EEteams[1].pD, EEteams[2].pD, EEteams[3].pD, EEteams[4].pD],
            'T Wins': [EEteams[0].tWins, EEteams[1].tWins, EEteams[2].tWins, EEteams[3].tWins, EEteams[4].tWins],
            'T PD': [EEteams[0].tPD, EEteams[1].tPD, EEteams[2].tPD, EEteams[3].tPD, EEteams[4].tPD]
        })
        self.AF = pd.DataFrame({
            ...
            'Skills ': [AFteams[0].sStr, AFteams[1].sStr, AFteams[2].sStr, AFteams[3].sStr, AFteams[4].sStr],
            'Played': [AFteams[0].played, AFteams[1].played, AFteams[2].played, AFteams[3].played, AFteams[4].played],
            'S Wins': [AFteams[0].wins, AFteams[1].wins, AFteams[2].wins, AFteams[3].wins, AFteams[4].wins],
            'S PD': [AFteams[0].pD, AFteams[1].pD, AFteams[2].pD, AFteams[3].pD, AFteams[4].pD],
            'T Wins': [AFteams[0].tWins, AFteams[1].tWins, AFteams[2].tWins, AFteams[3].tWins, AFteams[4].tWins],
            'T PD': [AFteams[0].tPD, AFteams[1].tPD, AFteams[2].tPD, AFteams[3].tPD, AFteams[4].tPD]
        })
        self.OC = pd.DataFrame({
            ...
            'Skills ': [OCteams[0].sStr, OCteams[1].sStr, OCteams[2].sStr, OCteams[3].sStr, OCteams[4].sStr],
            'Played': [OCteams[0].played, OCteams[1].played, OCteams[2].played, OCteams[3].played, OCteams[4].played],
            'S Wins': [OCteams[0].wins, OCteams[1].wins, OCteams[2].wins, OCteams[3].wins, OCteams[4].wins],
            'S PD': [OCteams[0].pD, OCteams[1].pD, OCteams[2].pD, OCteams[3].pD, OCteams[4].pD],
            'T Wins': [OCteams[0].tWins, OCteams[1].tWins, OCteams[2].tWins, OCteams[3].tWins, OCteams[4].tWins],
            'T PD': [OCteams[0].tPD, OCteams[1].tPD, OCteams[2].tPD, OCteams[3].tPD, OCteams[4].tPD]
        })
        self.WA = pd.DataFrame({
            ...
            'Skills ': [WAteams[0].sStr, WAteams[1].sStr, WAteams[2].sStr, WAteams[3].sStr, WAteams[4].sStr],
            'Played': [WAteams[0].played, WAteams[1].played, WAteams[2].played, WAteams[3].played, WAteams[4].played],
            'S Wins': [WAteams[0].wins, WAteams[1].wins, WAteams[2].wins, WAteams[3].wins, WAteams[4].wins],
            'S PD': [WAteams[0].pD, WAteams[1].pD, WAteams[2].pD, WAteams[3].pD, WAteams[4].pD],
            'T Wins': [WAteams[0].tWins, WAteams[1].tWins, WAteams[2].tWins, WAteams[3].tWins, WAteams[4].tWins],
            'T PD': [WAteams[0].tPD, WAteams[1].tPD, WAteams[2].tPD, WAteams[3].tPD, WAteams[4].tPD]
        })
        self.EA = pd.DataFrame({
            ...
            'Skills ': [EAteams[0].sStr, EAteams[1].sStr, EAteams[2].sStr, EAteams[3].sStr, EAteams[4].sStr],
            'Played': [EAteams[0].played, EAteams[1].played, EAteams[2].played, EAteams[3].played, EAteams[4].played],
            'S Wins': [EAteams[0].wins, EAteams[1].wins, EAteams[2].wins, EAteams[3].wins, EAteams[4].wins],
            'S PD': [EAteams[0].pD, EAteams[1].pD, EAteams[2].pD, EAteams[3].pD, EAteams[4].pD],
            'T Wins': [EAteams[0].tWins, EAteams[1].tWins, EAteams[2].tWins, EAteams[3].tWins, EAteams[4].tWins],
            'T PD': [EAteams[0].tPD, EAteams[1].tPD, EAteams[2].tPD, EAteams[3].tPD, EAteams[4].tPD]
        })
        self.Divisions = [self.NA, self.SA, self.WE, self.EE, self.AF, self.OC, self.WA, self.EA]
        self.Cities = ['New York    ', 'Los Angeles ', 'Mexico City ', 'Toronto     ', 'Washington  ',
                       'Buenos Aires', 'Santiago    ', 'Montevideo  ', 'Rio-Janeiro ', 'Caracas     ',
    ...
    def playoffs(self, tops, bottoms):
        ...
        S1 = self.series(Q1, Q2, 4, neu=True, hosted=False)
        S2 = self.series(Q3, Q4, 4, neu=True, hosted=False)
        print('Grand Finals!!!, best of 7')
        F = self.series(S1, S2, 4, neu=True, hosted=False)
        print(F, 'wins the WORLD TITLE')

    def series(self, x, y, n, neu=False, hosted=True):
        if not neu:
            host = x
        else:
